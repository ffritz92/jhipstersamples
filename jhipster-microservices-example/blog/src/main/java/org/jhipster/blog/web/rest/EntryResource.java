...
log.debug("SecurityUtils.getCurrentUserLogin().toString(): " + (String)SecurityUtils.getCurrentUserLogin().orElse(""));
        Page<Entry> page = entryRepository.findByBlogUserLoginOrderByDateDesc((String)SecurityUtils.getCurrentUserLogin().orElse(""), pageable);
